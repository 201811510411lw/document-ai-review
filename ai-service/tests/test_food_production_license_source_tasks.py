...
def test_fetch_one_food_production_license_source_task_uses_default_srm_sql():
    ...
    assert "ods_srm_srm_certification_df t1" in DEFAULT_FOOD_PRODUCTION_LICENSE_SOURCE_SQL
    assert "ods_srm_srm_attachment_df t2" in DEFAULT_FOOD_PRODUCTION_LICENSE_SOURCE_SQL
